...
export default function InfoCard({ buttonArr, inputValue  ,getValue ,getBtnValue,btnValue ,quantity, getQuantity}) {
  ...
  return (
    <div className="info-card">
      ...
      <PercentBtn buttonArr={buttonArr} btnValue={btnValue} getBtnValue={getBtnValue}  />
